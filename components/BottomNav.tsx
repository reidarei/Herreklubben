...
const tabs = [
  { href: '/', label: 'Hjem', ikon: 'hjem' as const },
  { href: '/klubbinfo', label: 'Klubbinfo', ikon: 'klubbinfo' as const },
  { href: '/kaaringer', label: 'Kåringer', ikon: 'kaaringer' as const },
  { href: '/profil', label: 'Profil', ikon: 'profil' as const },
]
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              ...
              style={{ color: aktiv ? 'var(--aksent-lys)' : 'var(--tekst-dempet)' }}
            >
              {ikoner[tab.ikon]}
              {tab.label}
            </Link>
